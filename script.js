document.addEventListener('DOMContentLoaded', function() {
    ...
    // Warna: Charcoal Grey | Font: Times New Roman
    // ========================================
        ...
        try {
            ...
            doc.autoTable({
                ...
                head: [[
                    ...
                    { content: 'Nama Anak', styles: { halign: 'left', valign: 'middle', font: 'times', fontStyle: 'bold' } },
                    { content: 'Bulan', styles: { halign: 'center', valign: 'middle', font: 'times', fontStyle: 'bold' } },
                    { content: 'Jumlah', styles: { halign: 'right', valign: 'middle', font: 'times', fontStyle: 'bold' } },
                ...
                columnStyles: {
                    ...
                    1: { halign: 'left', cellWidth: 56, valign: 'middle' },
                    2: { halign: 'center', cellWidth: 32, valign: 'middle' },
                    3: { halign: 'right', cellWidth: 38, valign: 'middle' },
                    4: { halign: 'left', cellWidth: 45, valign: 'middle' }
                },
                footStyles: {
                    font: 'times',
                    fillColor: [229, 231, 235],
