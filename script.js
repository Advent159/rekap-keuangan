document.addEventListener('DOMContentLoaded', function() {
    ...
    function addRow(name = '', month = '', amount = '') {
        ...
        // Perbaikan untuk mobile: nonaktifkan autocorrect dan autocapitalize
        ...
        // Jumlah - PERBAIKAN UNTUK MOBILE
        const tdAmount = document.createElement('td');
        const inputAmount = document.createElement('input');
        inputAmount.type = 'text';
        inputAmount.className = 'input-number';
        inputAmount.placeholder = '0';
        // Gunakan inputMode numeric untuk keyboard angka di mobile
        ...
        // Event listener untuk input - PERBAIKAN
        ...
        // Mencegah scroll berlebihan di mobile saat fokus
        inputAmount.addEventListener('focus', function(e) {
            // Scroll dengan smooth tanpa mengganggu viewport
            if (isMobile()) {
                setTimeout(() => {
        ...
        inputAmount.addEventListener('touchstart', function(e) {
            // Tidak melakukan apa-apa khusus, hanya mencegah default jika perlu
        }, { passive: true });
        ...
        // Event listeners untuk validasi - PERBAIKAN
        ...
        // Perbaikan untuk input nama di mobile
        ...
        // Perbaikan untuk select di mobile
    ...
    // Perbaikan untuk mobile: mencegah zoom saat fokus di input
    if (isMobile()) {
        document.addEventListener('focusin', function(e) {
            if (e.target.tagName === 'INPUT' || e.target.tagName === 'SELECT' || e.target.tagName === 'TEXTAREA') {
                // Tidak melakukan zoom berlebihan
                setTimeout(() => {
